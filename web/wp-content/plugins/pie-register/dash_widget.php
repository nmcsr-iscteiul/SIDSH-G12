	...
	class PieRegisterWidget{
		...
		function register_widget() {
			...
			if ( current_user_can('manage_options') )
				wp_register_sidebar_widget( 'piereg_invite_tracking', __('PR Invitation Code Tracking', 'pie-register' ), array($this, 'widget'), array( 'settings' => 'options-general.php?page=pie-register' ) );
		}
		...
		function widget( $args ) {
			...
			echo '<tr><td colspan="2" align="center"><em>'. __("Showing invitation code of current registered users only","pie-register") .'</em></td></tr>';

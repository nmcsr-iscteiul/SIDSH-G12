...
<form action="" method="post" id="frm_settings_overrides">
  ...
  <div class="fields">
    ...
    <label for="redirect_user" class="label_mar_top">
      <?php _e("When a user is logged in, do not show login, registration and forgot password links.",'pie-register') ?>
    </label>
  </div>
  <div class="fields">
    <div class="radio_fields">
    ...
    <label for="show_admin_bar" class="label_mar_top">
      <?php _e("Do not show admin bar.",'pie-register') ?>
    </label>
  </div>
  <div class="fields">
    <div class="radio_fields">
    ...
    <label for="block_WP_profile" class="label_mar_top">
      <?php _e("Redirect users to custom profile page, if one exists.",'pie-register') ?>
    </label>
  </div>
  <div class="fields">
    <div class="radio_fields">
    ...
    <label for="block_wp_login" class="label_mar_top">
      <?php _e("Do not allow users to login from the WordPress login page. Note: You must select an alternate login page.",'pie-register') ?>
    </label>
  </div>
  <div class="fields">
    <div class="radio_fields">
    ...
    <label for="allow_pr_edit_wplogin" class="label_mar_top">
      <?php _e("Allow Pie Register to add header Footer in wp-login.php.",'pie-register') ?>
    </label>
  </div>
  <div class="fields">
    <input name="action" value="pie_reg_settings" type="hidden" />
    <input type="submit" class="submit_btn submit_btn_mar_ryt" value="<?php _e("Save Settings","pie-register"); ?>" />
  </div>
</form>
</div>
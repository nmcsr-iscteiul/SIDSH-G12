...
public class App{
	...
	public void getHtml(List<String> title2, List<String> journal2, List<String> year2, List<String> authorToS2, List<String> filep2) throws IOException{
		...
		String htmlColumn = "<tr>"+ "<td><a href=file:///home/nrego/Documents/Code/SIDSH-G12/java/templates/Covid_Scientific_Discoveries_Repository/" + filep2.get(i)+">"+ title2.get(i)+"</a></td> <td>"+journal2.get(i)+"<td>"+year2.get(i)+"<td>"+authorToS2.get(i)+"</td>";
		list.add(htmlColumn);
		}
